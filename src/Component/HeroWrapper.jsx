...
const HeroWrapper = () => {
  ...
  function eventExecutor(event, renderImgRef) {
    ...
    img.style.width = window.innerWidth > 772 ? "200px" : "100px";
  ...
  return (
    <>
      <div
        ...
        className="w-full z-[60] -mt-[4vw]   px-[1.5vw] h-screen relative  overflow-hidden  "
      >
      ...
      <div
        ref={renderImgRef}
        className="current w-full overflow-hidden  h-[80vh] bottom-0   z-[40] absolute  left-0"
      ></div>
    </>
  );
};
